...
export class ExcelExportService {
  async generateRegistrationsCSV(registrations: Registration[]): Promise<string> {
    ...
    const rows = registrations.map((reg, index) => [
      ...
      reg.category,
      reg.delegateName || 'N/A',
      reg.delegateMobile || 'N/A',
      reg.delegateGender?.toUpperCase() || 'N/A',
  ...
  async generateRegistrationsExcel(registrations: Registration[]): Promise<Buffer> {
    ...
    worksheet.columns = [
      ...
      { header: 'Delegate Gender', key: 'delegateGender', width: 12 },
      { header: 'Delegate Attending', key: 'isDelegateAttending', width: 15 },
    ...
    registrations.forEach((reg, index) => {
      worksheet.addRow({
        ...
        delegateName: reg.delegateName || 'N/A',
        delegateMobile: reg.delegateMobile || 'N/A',
        delegateGender: reg.delegateGender?.toUpperCase() || 'N/A',
